...
namespace Amasty\Label\Block\Adminhtml\System\Config;
...
class Information extends \Magento\Config\Block\System\Config\Form\Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2:product_labels';
    ...
    public function getAdditionalModuleContent()
    {
        if ($this->moduleManager->isEnabled('Magento_GraphQl')
            && !$this->moduleManager->isEnabled('Amasty_LabelGraphQl')
        ) {
            $result[] = [
                'type' => 'message-notice',
                'text' => __('Enable amasty/product-labels-graphql module to '
                    . 'activate GraphQl and Product Labels. '
