...
{
    private const LABEL_ENTITY_DATA_MAP = [
    ...
    private const CATALOG_PART_DATA_MAP = [
        ...
        LabelFrontendSettingsInterface::ALT_TAG => 'alt_tag'
    ];

    private const EMPTY_COMBINE_CONDITION = [
