...
class Relation extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        /** @var \MageWorx\AlsoBought\Model\Relation $item */
        foreach ($relationItems as $item) {

            /** @var \MageWorx\AlsoBought\Model\ResourceModel\Relation $resource */
    ...
    protected function applyRelationsToTheProduct($productSku, $productId, array $links)
    {
        ...
        try {
            ...
            // Products can be deleted between the collect and apply actions - we don't log it.
